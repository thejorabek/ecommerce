...
class ElectronicsInfo extends StatefulWidget {
  ElectronicsInfo({Key? key, required this.info}) : super(key: key);

  Electronics info;
  @override
  State<ElectronicsInfo> createState() => _JewInfoState();
}

class _JewInfoState extends State<ElectronicsInfo> {
  @override
